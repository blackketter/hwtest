#!/usr/local/Cellar/esptool/2.7/libexec/bin/python3.7
#
...
class ESPLoader(object):
    ...
    def write(self, packet):
        ...
        while remain > 0:
          ...
          shorty = buf[starty:end]
          self.trace("Writing block of %d bytes: %s", len(shorty), HexFormatter(shorty))
          self._port.write(shorty)
